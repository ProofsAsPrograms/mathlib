...
variables (R) (A : Type v) [comm_semiring R] [comm_ring A] [algebra R A]
...
/-- The kernel of `quot_left_to_quot_sup` -/
@[simp]
lemma ker_quot_left_to_quot_supₐ :
  ring_hom.ker (quot_left_to_quot_supₐ R A I J) = J.map (I^.quotient.mkₐ R) :=
ker_quot_left_to_quot_sup I J
...
/-- The kernel of `quot_quot_mk`. -/
@[simp]
lemma ker_quot_quot_mkₐ : ring_hom.ker (quot_quot_mkₐ R A I J) = I ⊔ J :=
ker_quot_quot_mk I J
...
@[simp]
lemma quot_quot_equiv_quot_sup_quot_quot_mkₐ (x : A) :
  quot_quot_equiv_quot_supₐ R A I J (quot_quot_mkₐ R A I J x) = (I ⊔ J)^.quotient.mkₐ R x :=
rfl

@[simp]
lemma quot_quot_equiv_quot_sup_symm_quot_quot_mkₐ (x : A) :
  (quot_quot_equiv_quot_supₐ R A I J).symm ((I ⊔ J)^.quotient.mkₐ R x) =
    quot_quot_mkₐ R A I J x :=
rfl
...
@[simp]
lemma quot_quot_equiv_comm_quot_quot_mkₐ (x : A) :
  quot_quot_equiv_commₐ R A I J (quot_quot_mkₐ R A I J x) = quot_quot_mkₐ R A J I x :=
rfl

@[simp]
lemma quot_quot_equiv_comm_comp_quot_quot_mkₐ :
  alg_hom.comp ↑(quot_quot_equiv_commₐ R A I J) (quot_quot_mkₐ R A I J) = quot_quot_mkₐ R A J I :=
alg_hom.ext $ quot_quot_equiv_comm_quot_quot_mkₐ R A I J
...
@[simp]
lemma quot_quot_equiv_quot_of_le_quot_quot_mkₐ (x : A) (h : I ≤ J) :
  quot_quot_equiv_quot_of_leₐ R A h (quot_quot_mkₐ R A I J x) = J^.quotient.mkₐ R x := rfl

@[simp]
lemma quot_quot_equiv_quot_of_le_symm_mkₐ (x : A) (h : I ≤ J) :
  (quot_quot_equiv_quot_of_leₐ R A h).symm (J^.quotient.mkₐ R x) =
    (quot_quot_mkₐ R A I J x) := rfl

@[simp]
lemma quot_quot_equiv_quot_of_le_comp_quot_quot_mkₐ (h : I ≤ J) :
  alg_hom.comp ↑(quot_quot_equiv_quot_of_leₐ R A h) (quot_quot_mkₐ R A I J) =
    J^.quotient.mkₐ R :=
rfl

@[simp]
lemma quot_quot_equiv_quot_of_le_symm_comp_mkₐ (h : I ≤ J) :
  alg_hom.comp ↑(quot_quot_equiv_quot_of_leₐ R A h).symm (J^.quotient.mkₐ R) =
    quot_quot_mkₐ R A I J :=
rfl
